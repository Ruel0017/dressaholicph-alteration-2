                                                        ...
                                                        @csrf 
                                                            <div class="form-group">
                                                                      <div class="row">
                                                                                <div class="col-6">
                                                                                          ...
                                                                                          <input class="date form-control text-right" type="text" id='date' name='date' required>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <select class="form-control clothes" name="clothes" id="clothes" required>
                                                                                <option selected value="">Please Select Dress/Clothes</option> @foreach ($clothe as $clothes) <option value="{{ $clothes->id }}">{{ $clothes->clothesName }}</option> @endforeach
                                                                      </select>
          ...
          <form method="POST" action="{{ route('user.CreateAppFabric') }}"> 
              ...
              <div class="form-group">
                              <div class="row">
                                        <div class="col-6">
                                                  <label for="date">Date</label>
                                                  <input class="date form-control text-right" type="text" name="date_fabric" id="date_fabric" required>
                                                  <span class="fa fa-calendar calendarspan"></span>
                                        </div>
                                        <div class="col-6">
                                                  <label for="time">Time</label>
                    ...
                    <div class="form-group">
                              ...
                              <select class="form-control" name="fabric" id="fabric" disabled>
                                        <option selected value="">Please Select Types of Fabric</option> @foreach ($fabric as $fabrics) <option value="{{ $fabrics->id }}">{{ $fabrics->fabricName }}</option> @endforeach
                              </select>
                    ...
                    <div class="form-group">
                              <label for="amount">Total Amount</label>
                              <span></span>
                              <input class="form-control" type="text" name="amount_fabric" id="amount_fabric" value="" readonly>
                    </div>
                    {{-- <input class="form-control" type="text" name="" value="{{$repairPrice}}" readonly> --}} <div class="card-footer">
                              <button type="submit" class="btn btn-primary">Submit</button>
                </form>
                                                ...
                                                $.each(data, function(key, repairPriceDB) 
                                                {
                                                    $('select[name="fabric"]').prop('disabled', false)
                                                        .append(
                                                            ...
                                                            document.getElementsByName('amount_fabric')[0].value = '';
                                                });
                                            } else {
                                                console.log('error to tanga')
                                                $('#fabric').empty();
                                        ...
                                        success: function(data) {
                                            if (data) {
                                                ...
                                                $.each(data, function(repairAmount) { 
                                                    ...
                                                    // $('input[name=amount]').val()= ;
                                                    // alert(a[0]/2);
                                                    document.getElementsByName('amount_fabric')[0].value = Amount;
                                                });
                                            } else {
                                                console.log('error to tanga')
                                                $('#fabric').empty();
