            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="repair">
                        <option value="0">Please Select Dress/Clothes</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="repair">
                        <option value="0">Please Select Types of Repair</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="repair">
                        <option value="0">Please Select Types of Fabric</option>
